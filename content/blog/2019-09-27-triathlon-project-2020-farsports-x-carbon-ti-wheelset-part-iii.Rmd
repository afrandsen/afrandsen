...
As argued above I opted for the Carbon-TI hubs because of their many positives. The SKF bearings which are installed from factory are top tier bearings performs better than most other bearings preinstalled in other hubs (DT Swiss, Tune, etc.).^[See Hambini's blog post [here](https://www.hambini.com/blog/post/testing-to-find-the-fastest-bicycle-wheel-hubs/) for a test of the hubs.]
